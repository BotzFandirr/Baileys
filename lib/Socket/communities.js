...
const extractCommunityMetadata = (result) => {
    ...
    const eph = (_c = (_b = (0, WABinary_1.getBinaryNodeChild)(community, 'ephemeral')) === null || _b === void 0 ? void 0 : _b.attrs) === null || _c === void 0 ? void 0 : _c.expiration;
    ...
    const metadata = {
        ...
        desc,
        descId,
        linkedParent: ((_e = (_d = (0, WABinary_1.getBinaryNodeChild)(community, 'linked_parent')) === null || _d === void 0 ? void 0 : _d.attrs) === null || _e === void 0 ? void 0 : _e.jid) || undefined,
